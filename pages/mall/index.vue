    ...
    <div>
        ...
        <div id="topBanner" class="topbanner">
            <div class="w tp">
                ...
                <a id="jd_close" href="javascript:;" class="close-banner"></a>
            </div>
        </div>
        <!--京东的topbanner部分 end-->
        ...
        <div class="w clearfix">
            <div class="logo">
                ...
                >
                <div class="db11">
                    <a href="#"><img src="images/dong.gif" alt="db11" /></a>
                </div>
            </div>
            <div class="search">
                <input id="" type="text" name="" value="保险柜" />
                <button>搜索</button>
            </div>
            <div class="car">
                <a href="#">我的购物车</a>
            ...
            <div class="hotwords">
                <ul>
                    <a href="#" class="col-red"><li>八代酷睿</li></a>
                    <a href="#"><li>直降1000</li></a>
                    <a href="#"><li>农资畜牧</li></a>
                    <a href="#"><li>Armani开业</li></a>
                    <a href="#"><li>智能电视</li></a>
                    <a href="#"><li>车载收音机</li></a>
                    <a href="#"><li>小米note2</li></a>
                    <a href="#"><li>食品中秋季</li></a>
                </ul>
            </div>
        </div>
        <!--顶部完成-->
                ...
                <div class="lifeservi">
                    ...
                    <div class="dd">
                        <ul>
                            ...
                            <li class="lifeservi-icon3">
                                <a href="#"><i></i><span>话费</span></a>
                            </li>
                            <li class="lifeservi-icon4">
                                <a href="#"><i></i><span>话费</span></a>
                            </li>
                            <li class="lifeservi-icon5">
                                <a href="#"><i></i><span>话费</span></a>
                            </li>
                            <li class="lifeservi-icon6">
                                <a href="#"><i></i><span>话费</span></a>
                            </li>
                            <li class="lifeservi-icon7">
                                <a href="#"><i></i><span>话费</span></a>
                            </li>
                            <li class="lifeservi-icon8">
                                <a href="#"><i></i><span>话费</span></a>
                            </li>
                            <li class="lifeservi-icon9">
                                <a href="#"><i></i><span>话费</span></a>
                            </li>
                            <li class="lifeservi-icon10">
                                <a href="#"><i></i><span>话费</span></a>
                            </li>
                            <li class="lifeservi-icon11">
                                <a href="#"><i></i><span>话费</span></a>
                            </li>
                            <li class="lifeservi-icon12">
                                <a href="#"><i></i><span>话费</span></a>
                            </li>
                            <li class="lifeservi-icon13">
                                <a href="#"><i></i><span>话费</span></a>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="jd-footer">
            ...
            <div class="w againw">
                ...
                <div class="copyright">
                    京公网安备
                    11000002000088号|京ICP证070359号|互联网药品信息服务资格证编号(京)-经营性-2014-0008|新出发京零
                    字第大120007号<br />
                    互联网出版许可证编号新出网证(京)字150号|出版物经营许可证|网络文化经营许可证京网文[2014]2148-348号|违法和不良信息举报电话：4006561155<br />
                    Copyright © 2004 - 2017 京东JD.com
                    版权所有|消费者维权热线：4006067733经营证照<br />
                    京东旗下网站：京东支付|京东云<br />
                </div>
                <div class="message">
